...
# -*- coding: utf-8 -*-
#
# marbles documentation build configuration file, created by
...
project = 'marbles'
copyright = '2016, Jane Adams and Leif Walsh'
...
latex_documents = [
    (master_doc, 'marbles.tex', 'marbles Documentation',
     'Jane Adams and Leif Walsh', 'manual'),
]
...
man_pages = [
    (master_doc, 'marbles', 'marbles Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'marbles', 'marbles Documentation',
     author, 'marbles', 'One line description of project.',
     'Miscellaneous'),
]
